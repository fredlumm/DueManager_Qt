...
QT_MOC_LITERAL(5, 92, 5)
    ...
    "SearchDialog\0on_SearchButton_clicked\0"
    "\0on_CancelButton_clicked\0"
    "on_searchResult_doubleClicked\0index\0"
};
...
void SearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_searchResult_doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}
